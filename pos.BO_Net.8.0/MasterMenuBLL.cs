...
namespace pos.BLL
{
    public class MasterMenuBLL:IMasterMenuBLL
    {
        ...
        public MasterMenuBLL(IMasterMenu masterMenu)
        {
            _masterMenuDAL = masterMenu;
        }
       ...
       void IMasterMenuBLL.Update(MasterMenuDTO entity)
        {
            var masterMenu = new pos.BO.MasterMenu
            {
                id_menu = entity.id_menu,
        ...
        int IMasterMenuBLL.GetCountMenu(string name)
        { try
            {
        ...
        IEnumerable<MasterMenuDTO> IMasterMenuBLL.GetByName(string name)
        {
        ...
        IEnumerable<MasterMenuDTO> IMasterMenuBLL.GetWithPaging(int pageNumber, int pageSize, string name)
        {
            pos.BO.MasterMenu masterMenu = new pos.BO.MasterMenu();
            var masterMenuDTOs = new List<MasterMenuDTO>();
